<template>
    <div class="pt-2">
        <form>
                ...
                <div class="flex xs12">
                    <va-card :title="$t('forms.selects.agencySettings')" stripe="gray">
                        <div class="row">
                            <div class="flex md4 sm6 xs12">
                                <va-input
                                        :label="$t('forms.selects.defaultPricePerPage')"
                                        v-model="defaultPricePerPage"
                                />
                            </div>
                            <div class="flex md4 sm6 xs12">
                                <va-input
                            ...
                            <div class="flex md4 sm6 xs12">
                                <va-input
                                        :label="$t('forms.selects.defaultPricePerDay')"
                                        v-model="defaultPricePerDay"
                                />
                            </div>
                        </div>
                    </va-card>
            ...
            <!--<div class="row justify&#45;&#45;center flex xs12 md6">-->
            <!--<va-button :to="{name: 'mainpage'}">-->
            <!--{{ $t('forms.selects.cancel') }}-->
            <!--</va-button>-->
            <!--<va-button @click="saveAgency()">-->
            <!--{{ $t('forms.selects.save') }}-->
            <!--</va-button>-->
            <!--</div>-->
        </form>
    ...
    export default {
        ...
        methods: {
            saveAgency() {
                ...
                params.append('agencyName', this.agency.agencyName);
                params.append('city', this.agency.city);
                params.append('id', this.agency.id);

                axios.post(`/api/agency`, params)
                    .then(response => {

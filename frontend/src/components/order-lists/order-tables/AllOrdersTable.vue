<template>
  <va-card :title="$t('tables.allOrders')" stripe="secondary">
    ...
    <OrderTableButtons></OrderTableButtons>
  </va-card>
</template>

<script>
  import {debounce} from 'lodash'
  import orders from '../../../data/allOrders.json'
  import OrderTableButtons from "./OrderTableButtons.vue";

  export default {
    components: {OrderTableButtons},
    data() {
      return {
        term: null,
        perPage: '4',
